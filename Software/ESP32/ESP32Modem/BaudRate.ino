...
void ChangeBaudRate()
{
    ...
    while (true)
    {
        ...
        {
            C64.println();
            C64.print(F("Unsupported Baud Rate"));
        }
    }
}
...
{
	/*
    C64.print(F("Autodetecting Baud Rate (press 'u'): "));
    ...
    else
    {
        if (baud == -1)
        {
            C64.println(F("Timeout"));
            return;
        }
        else if (baud == -2)
        {
            C64.println(F("Invalid Baud Rate"));
            return;
        }
    }
	*/
